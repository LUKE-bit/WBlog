...
import com.wang.myblog.dao.BlogMapper;
...
import com.wang.myblog.utils.DateUtils;
import com.wang.myblog.utils.MarkDownToHtmlUtil;
import com.wang.myblog.utils.RedisKeyUtils;
...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public Result saveReply(Integer id, String replyComment) {
        int index = blogMapper.saveReply(id, replyComment);
        Result result = new Result();
        if(index > 0){
            result.setCode(200);
