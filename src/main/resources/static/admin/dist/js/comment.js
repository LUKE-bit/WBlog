        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    var c = '<button type="button" class="btn btn-info" onclick="reply(\''+row.id+'\',this)"> <i class="far fa-edit"></i>&nbsp;回复</button>&nbsp;'
...
function reply(id,obj) {
    ...
    $('#confirmReply').click(function () {
        ...
        if (isNull(replyComment)){
            swal("内容不能为空", {
                icon: "error",
            });
            return;
        }
        var data = {"replyComment":replyComment,"id":id};
        $.ajax({
            type: "POST",
            url: "/admin/saveReply",
            data: data,
